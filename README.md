...
The plugin was created to emulate table-valued parameters ([supported](https://learn.microsoft.com/en-us/dotnet/framework/data/adonet/sql/table-valued-parameters) in SQL Server but [not](https://github.com/npgsql/npgsql/issues/5415) PostgreSQL) to improve code portability.
